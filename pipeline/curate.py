"""Curation en mode degrade pour La Frontiere (aucune cle API requise).
...
La logique de score et de resume est isolee dans deux fonctions
(score_heuristique, resume_heuristique) pour qu'un futur branchement d'une
cle API Claude n'ait qu'a remplacer ces deux fonctions, pas la structure
du pipeline.
"""
